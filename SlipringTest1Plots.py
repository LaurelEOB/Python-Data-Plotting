...
if __name__ == "__main__":
    ...
    dataFile = pd.read_csv('/Users/bloss/OneDrive/documents/DataSets/ResistanceData-2024-7-08_SlipringTest3.csv')
    ...
    plt.title("Slipring Test 3 (-20C)")
    plt.xlabel("Time [min]")
    plt.ylabel("Resistance [ohms]")
    plt.legend(["Res 1","Res 2","Res 3"])
    plt.plot([80], linestyle = 'dashed')
